 ...
 * a unique id.
 * 
 * @author Sarah Heckman, Darren Gonsalves,
 */
public class StudentDirectory {
	...
	/**
	 * Gets the Student object matches the input Student ID. If a student is not
	 * located through the Id, then null is returned.
	 * 
	 * @return the student object that matches the input id
	 * @param id of the unique student object
	 */
	public Student getStudentById(String id) {
		for (int i = 0; i < getStudentDirectory().length; i++) {
