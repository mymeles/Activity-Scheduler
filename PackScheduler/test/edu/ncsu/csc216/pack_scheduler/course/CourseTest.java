...
public class CourseTest {
    ...
    public void testSetName() {
        ...
        c = null;
        try {
            c = (Activity) new Course("HESFQ 101", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
            fail();
        } catch (IllegalArgumentException e) {
            assertNull(c);
            assertEquals("Name's length should be between 5 and 8, inclusive.", e.getMessage());
...
////        // Test valid course with meeting times (not arranged)
	...
	public void testComapreTo() {
		...
		Course c3 = new Course("CSC 226", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
		Course c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);

		// compare equal course Name and scetion
		...
		try {
			...
			assertNotNull(c1); // no good assert  check to see anything in s1 
		}
